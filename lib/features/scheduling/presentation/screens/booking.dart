...
import '../../data/services/UdfRetrivalService.dart';
import '../utils/BookingFormBloc/booking_form_bloc.dart';
import '../utils/TileInteractionHandleTap.dart';
import '../utils/showBottomSheet.dart';
import '../widgets/CustomContent/CustomContent.dart';
import '../widgets/TileBuider.dart';
...
import '../widgets/shared/resource_component.dart';
import 'NotesPageScreen.dart';
...
class _BookingFormState extends State<BookingForm> {
  ...
  // late final SectionFetcher _sectionFetcher;
  // late final UdfExtractor _udfExtractor;
  // late final Future<List<SectionModel>> _sectionsFuture;
  ...
  void _onSavePressed() {
    ...
    print(_formData);
    final jsonobj = jsonEncode(_formData);
    print(jsonobj);
  }
  ...
  void initState() {
    ...
    // _sectionFetcher = SectionFetcher(remoteSource: remoteSource);
  ...
  //
  //   _sectionFetcher = SectionFetcher(remoteSource: remoteSource);
  //   // _udfExtractor = UdfExtractor();
  //
  //   _sectionsFuture = _sectionFetcher.fetchSections(_token);
  //   super.initState();
  // }
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      )..add(LoadBookingFormEvent(token: _token)),
      child: Scaffold(
        backgroundColor: Colors.white,
        appBar: AppBar(
          // same leading and title as before
        ),
