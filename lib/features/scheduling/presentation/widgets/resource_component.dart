...
//            Text(
//             'Resource',
//             style: TextStyle(fontSize: TextSizes().bodyMedium, fontWeight: FontWeight.w500),
//           ),
...
//               Container(width: 1, height: 21, color: Color.fromRGBO(82, 82, 82, 0.6)),
//               SizedBox(width: 7),
//               ...avatarUrls.map(
//                 (url) => Padding(
...
//             bottomSheetContent: BottomSheetOptions(
//               title: 'Tasks',
//               options: ['Research', 'User Interface Design', 'Wireframing', 'Prototyping'],
//             ),
//           ),
//         ],
//       ),
